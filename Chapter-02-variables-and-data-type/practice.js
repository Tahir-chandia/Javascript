...
// var can be redeclared , updated and global scope
// let cannot be redeclared ,but it can be updated and  block scope
// const cannot be redeclared ,also cannot be updated updated and block scope
...
//it will give reference error: (variable name) is not defined
...
//null was  empty  if we want to empty variable and we can add value of undefined after declared
